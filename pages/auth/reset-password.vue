  ...
  <div class="mh-screen__adjust-padding">
    ...
    <div class="pt-3 pb-6">
      <v-card width="500" max-width="100%" outlined rounded class="mx-auto py-4 pb-6 pa-sm-6">
        ...
        <v-card-title class="justify-center text-center pt-0 px-md-12 mb-4 text-capitalize grey--text lighten-2">
          {{ $t('YouCanNowChangeYourPassword') }}
        </v-card-title>
        <v-form
        ...
        >
          <v-card flat>
            <password-input v-model="password" :label="$t('newPassword')" info=" كلمة المرور الخاص بك"
            required />
            <password-input v-model="confirmedPassword" :label="$t('enterConfirmedPassword')" info=" كلمة المرور الخاص بك"
            required />
          </v-card>
