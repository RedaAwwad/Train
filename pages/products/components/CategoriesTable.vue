  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: this.$t('products'), align: 'center', value: 'products' },
        { text: this.$t('collecting'), align: 'center', value: 'collecting' },
        { text: this.$t('giftCards'), align: 'center', value: 'gift_cards' },
