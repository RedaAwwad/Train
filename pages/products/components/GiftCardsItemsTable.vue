...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: this.$t('category'), align: 'center', value: 'tax_group' },
        { text: this.$t('price'), align: 'center', value: 'price' },
        { text: this.$t('activeItem'), align: 'center', value: 'is_active' },
  ...
  methods: {
    navigateToProductDetails(id) {
      this.$router.push(this.localePath(`/products/gift-cards/${id}`));
    }
  }
}
</script>
